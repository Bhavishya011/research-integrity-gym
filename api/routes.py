...
ROUTE_TABLE = [
    ...
    {"method": "POST", "path": "/reset",    "tag": "openenv",    "description": "Start new episode, returns Observation"},
    {"method": "POST", "path": "/step",     "tag": "openenv",    "description": "Execute action, returns obs/reward/done/info"},
    {"method": "GET",  "path": "/state",    "tag": "openenv",    "description": "Current episode state (no ground truth)"},
    {"method": "GET",  "path": "/tasks",    "tag": "openenv",    "description": "List all tasks with action schemas"},
    {"method": "POST", "path": "/grader",   "tag": "evaluation", "description": "Run grader on a completed episode"},
